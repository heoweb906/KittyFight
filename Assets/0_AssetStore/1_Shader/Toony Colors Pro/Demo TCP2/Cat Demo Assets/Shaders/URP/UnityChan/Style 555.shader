...
Shader "Toony Colors Pro 2/Examples URP/Cat Demo/UnityChan/Style 555"
{
    Properties
    {
        [TCP2HeaderHelp(Base)]
        ...
        _OutlineWidth ("Width", Range(0.1,20)) = 1
    ...
    SubShader
    {
        ...
        TCP2_TEX2D_WITH_SAMPLER(_ShadowColor);
        ...
        inline float2 GetScreenUV(float2 clipPos)
        {
            ...
            screenUV.x *= sign(UNITY_MATRIX_P[1].y);
            return screenUV / UNITY_MATRIX_P._m11;
        }
        ...
        Pass
        {
            ...
            half4 Fragment(Varyings input, half vFace : VFACE) : SV_Target
            {
                ...
                float3 __shadowColor = ( _SColor.rgb * TCP2_TEX2D_SAMPLE(_ShadowColor, _ShadowColor, input.pack1.xy).rgb );
