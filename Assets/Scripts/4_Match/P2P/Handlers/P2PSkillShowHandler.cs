...
public class P2PSkillShowHandler : IP2PMessageHandler
{
    ...
    public void Handle(string msg)
    {
        ...
        if (MatchResultStore.myPlayerNumber == 1) skillCardController.ShowSkillCardList(2, model.arraySkilNumbers);
        else skillCardController.ShowSkillCardList(1, model.arraySkilNumbers);
    }
}